...
function preload() {
  ...
  symbolsmixedA = loadTable('assets/text/symbolsmixedA.csv');
  symbolsmixedB = loadTable('assets/text/symbolsmixedB.csv');
  symbolsmixedC = loadTable('assets/text/symbolsmixedC.csv');
  story = loadTable('assets/text/unusta.csv');
}
...
function tempA() {
  ...
  redButton.mousePressed(StoryA8);
...
function titles1() {
  ...
  clickSND();
  clicks = 2;
  textButton = createButton('eˉlektron esitleb');
...
function titles2() {
  ...
  clickSND();
  clicks = 4;
  textButton = createButton('idee, muusika ja kood - Sander Saarmets');
...
function titles3() {
  ...
  clickSND();
  clicks = 5;
  textButton = createButton('tekst - Jan Kaus');
  textButton.style('letter-spacing', '0.15rem');
  textButton.mousePressed(nextAbstractAx2);
  textButton.center();
}
...
function unustaA() {
  clearup();
  removeAllButtons();
  let unusta = createA('', 'U N U S T A');
  unusta.center();
  unusta.mousePressed(nextAbstractAx2);
}
...
function Story() {
  ...
  clickSND();
  clicks = 10;
  StoryButton = createButton('see juhtus selles mõttetus linnas');
...
function redBlue() {
  ...
  textButton = createButton('üks punane &#x2596 teine sinine')
  textButton.center();
  textButton.mousePressed(nextStory);
}
...
function laguneb() {
  ...
  removeAllButtons();
  clickSND();
  aButton = createButton('kõik');
  aButton.mousePressed(nextStory);
  const dwA = new DanceSpan(aButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dwA);
  bButton = createButton('laguneb');
  bButton.mousePressed(nextStory);
  const dwB = new DanceSpan(bButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dwB);
  cButton = createButton('reaalajas');
...
function mureneb() {
  ...
  removeAllButtons();
  clickSND();
  aButton = createButton('kivi mureneb');
  aButton.mousePressed(nextAbstractA);
  const dwA = new DanceSpan(aButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dwA);
  bButton = createButton('ja');
  bButton.mousePressed(nextAbstractA);
  const dwB = new DanceSpan(bButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dwB);
  cButton = createButton('puit pudeneb');
...
function munakivi() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('seal munakiviteedel');
...
function lookas() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('lookas puukökatsite vahel');
...
function etendus() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('siin vist antakse aastas üks etendus');
  textButton.mousePressed(nextAbstractA);
  textButton.center();
}
...
function sisse() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('midagi paremat polnud nagunii teha');
  textButton.mousePressed(nextAbstractAx3);
  textButton.center();
}
...
function ringi() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('ma kõndisin ringi');
  textButton.mousePressed(nextAbstractAx2);
  textButton.center();
}
...
function sammud() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('sammud kajasid');
  textButton.mousePressed(nextAbstractAx3);
  textButton.center();
}
...
function seal() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('aga seal oli ');
...
function keset() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('keset lumevälja ');
...
function raamas() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('raamas majade vahel');
  textButton.mousePressed(nextStory);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function jump1B() {
  ...
  clickSND();
  clicks = 70;
  textButton = createButton('üks seljaga teise poole');
  textButton.mousePressed(nextStory);
  textButton.center();
}
...
function rewindA1() {
  ...
  easing = 0.005;
  clicks = 34;
  symbolButton = createButton('KUS MA OLINGI?');
...
function rewindA1B() {
  ...
  easing = 0.005;
  clicks = 10;
  symbolButton = createButton('&#x2594 see juhtus (vist) selles mõttetus linnas');
  symbolButton.mousePressed(nextStory);
  symbolButton.center();
  presetA1Reset();
  bcol += 25;
...
function StoryA2() {
  ...
  flashMute();
  clicks = 80;
  textButton = createButton('olid see SINA?');
  textButton.center();
...
function sind() {
  ...
  presetA2Reset();
  clicks = 81;
  textButton = createButton('nägin ma SIND?');
  textButton.center();
  textButton.mousePressed(nextStory);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
...
function meenutas() {
  ...
  clickSND();
  clicks = 88;
  textButton = createButton('või kas see ikka meenutas sind?');
  textButton.center();
  textButton.mousePressed(nextAbstractAx3);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
...
function mantel() {
  ...
  textButton = createButton('sul oli see ilus mantel')
  textButton.center();
  textButton.mousePressed(nextStory);
}
...
function rewind2() {
  ...
  clickSND();
  clicks = 89;
  symbolButton = createButton('MÄLETAN');
...
function jumpA2() {
  ...
  clickSND();
  clicks = 98;
  textButton = createButton('suurte nööpidega');
  textButton.mousePressed(nextStory);
  textButton.center();
}
...
function kuidas() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('kuidas ma seda ei mäleta?')
  textButton.mousePressed(nextAbstractAx2);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function manada() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('mõnikord ma ei suuda isegi su nägu silme ette manada')
  textButton.center();
  textButton.mousePressed(nextAbstractA);
}
...
function kasoliseemantel() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('kas oli see mantel?')
  textButton.mousePressed(nextAbstractA);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function tumesinine() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('aga kas oli see tumesinine?')
...
function tumesiniste() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('suurte tumesiniste nööpidega?')
  textButton.mousePressed(nextAbstractAx2);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function eiolnudju() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('ei olnud ju')
  textButton.center();
  textButton.mousePressed(nextAbstractAx2);
}
...
function eiolnud() {
  ...
  clickSND();
  flashMute();
  textButton = createButton('EI OLNUD!')
  textButton.center();
  textButton.mousePressed(nextAbstractA);
}
...
function andnud() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('sa olid siis selle juba ära andnud')
  textButton.center();
  textButton.mousePressed(nextAbstractAx2);
}
...
function mikssee() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('miks see sinine mind üldse häiris?')
...
function maastik0() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('äkki hoopis see maastik mõjus kuidagi')
  textButton.mousePressed(nextAbstractA);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function maastik() {
  ...
  textButton = createButton('see mustvalge maastik')
  textButton.center();
  textButton.mousePressed(nextStory);
}
...
function jump3B() {
  ...
  clickSND();
  clicks = 127;
  textButton = createButton('kõik see &#x2596 mis jääb musta ja valge vahele');
...
function StoryA4() {
  ...
  textButton = createButton('oli vist tõesti samamoodi nagu maalil');
  textButton.center();
  textButton.mousePressed(nextStory);
}
...
function lumi() {
  ...
  textButton = createButton('õhuke lumekiht')
  textButton.mousePressed(nextStory);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function kumab() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('nii et muld hakkab läbi kumama')
  textButton.center();
  textButton.mousePressed(nextAbstractA);
}
...
function kumab2() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('kumab lumest läbi')
  textButton.mousePressed(nextAbstractAx3);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function rewind4() {
  ...
  clickSND();
  clicks = 131;
  textButton = createButton('oli see ikka samamoodi nagu maalil?');
  textButton.center();
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
  textButton.mousePressed(nextStory);
...
function jump4B() {
  ...
  clickSND();
  clicks = 141;
  textButton = createButton('selline &#x2596 mis paneb kõik elusa närbuma');
  textButton.mousePressed(nextStory);
  textButton.center();
}
...
function StoryA5() {
  ...
  clickSND();
  clicks = 156;
  textButton = createButton('nii et ei mingit lumekihti');
  textButton.center();
  textButton.mousePressed(nextStory);
}
...
function redBlue2() {
  ...
  textButton = createButton('see sinine kriipsujuku seisis seljaga punase poole')
  textButton.center();
...
function jump5B() {
  ...
  clickSND();
  clicks = 165;
  textButton = createButton('nad seisid kõrvuti &#x2594 aga mitte vastamisi');
...
function astuma() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('justkui hakkaks kohe astuma');
...
function olen() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('või noh &#x2596 olen');
  textButton.mousePressed(nextAbstractAx2Bounce);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
  dancingWords.push(dw);
}
...
function ema() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('ütles su ema');
...
function kurat() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('kurat küll');
  textButton.mousePressed(nextAbstractAx3Bounce);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
  dancingWords.push(dw);
}
...
function valetasid() {
  ...
  clickSND();
  flashMute();
  textButton = createButton('sa valetasid ka');
  textButton.mousePressed(nextAbstractAx2Bounce);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
  dancingWords.push(dw);
}
...
function keegi() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('ütlesid &#x2596 et sul on keegi');
  textButton.mousePressed(nextAbstractAx3Bounce);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
  dancingWords.push(dw);
}
...
function selja() {
  ...
  clickSND();
  bcolTarget = 15; easing = 0.1;
  textButton = createButton('pöörasid selja');
  textButton.center();
  textButton.mousePressed(nextStory);
}
...
function StoryA6() {
  ...
  bcolTarget = 25; easing = 0.1;
  clicks = 192;
  textButton = createButton('aga ikka ei hakka kergem');
  textButton.center();
  textButton.mousePressed(nextStory);
}
...
function lahed() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('sa lähed')
  textButton.center();
  textButton.mousePressed(nextAbstractAx2);
}
...
function laksid() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('läksid')
  textButton.center();
  textButton.mousePressed(nextAbstractAx3);
}
...
function tagasi() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('tagasi ei vaadanud')
  textButton.center();
  textButton.mousePressed(nextAbstractA);
}
...
function loonud() {
  ...
  clickSND();
  flashMute();
  textButton = createButton('ma oleksin sind seal peaaegu löönud')
  textButton.center();
  textButton.mousePressed(nextAbstractAx2);
}
...
function midagivist() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('midagi vist')
...
function kohas() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('et sa oled kohas')
...
function kuseisaa() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('kus ei saa ümber pöörata')
  textButton.mousePressed(nextAbstractAx2);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function ilmaminuta() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('ilma minuta')
  textButton.mousePressed(nextAbstractA);
  textButton.center();
}
...
function agaei() {
  ...
  flashMute();
  bcolTarget = 25; easing = 0.1;
  textButton = createButton('aga ei')
  textButton.mousePressed(nextStoryBounce);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function aprill() {
  ...
  textButton = createButton('aprill')
...
function nali() {
  ...
  clickSND();
  addOne();
  textButton = createButton('see oli nali');
...
function seeeisaaolla() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('see ei saa olla');
  textButton.mousePressed(nextAbstractABounce);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function mingi() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('ma olen teda ju mingi');
  textButton.mousePressed(nextAbstractABounce);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function mitterohkem() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('mitte rohkem');
  textButton.mousePressed(nextAbstractAx2Bounce);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function oktoober() {
  ...
  clickSND();
  flashMute();
  textButton = createButton('aga kui oli ikkagi oktoober');
  textButton.center();
  textButton.mousePressed(nextStoryBounce);
}
...
function kasselle() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('kas selle kõhu pärast?');
  textButton.center();
  textButton.mousePressed(nextAbstractAx3);
}
...
function StoryA8() {
  ...
  bcolTarget = 15; easing = 0.1;
  clicks = 248;
  textButton = createButton('miks ma sellest varem pole mõelnud');
  textButton.center();
  textButton.mousePressed(nextStory);
}
...
function ilmselge() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('kurat')
  textButton.mousePressed(nextAbstractAx3);
  const dwA = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dwA)
  textButton2 = createButton('ilmselge')
...
function kuidasmavarem() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('kuidas ma varem')
  textButton.center();
  textButton.mousePressed(nextAbstractA);
}
...
function agaolen() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('aga äkki olen?')
  textButton.mousePressed(nextAbstractAx2);
  const dwR = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dwR)
}
...
function ikkaolen() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('või tõesti pole?')
  textButton.center();
  textButton.mousePressed(nextAbstractAx2);
}
...
function thought() {
  ...
  textButton = createButton('polegi mõelnud &#x2596 et')
  textButton.center();
...
function rewind8() {
  ...
  clickSND();
  clicks = 249;
  textButton = createButton('kui ongi oktoober');
  textButton.mousePressed(nextStory);
  textButton.center();
  bcol += 25;
}
...
function jump8() {
  ...
  presetA8Two();
  clicks = 259;
  textButton = createButton('mis oleks');
...
function jump8B() {
  ...
  clickSND();
  clicks = 260;
  textButton = createButton('kui ta oleks minu oma');
  textButton.mousePressed(nextAbstractA);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function agakuimapolegi() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('aga kui ma pole mõelnud');
  textButton.center();
...
function siismiks() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('siis miks?');
  textButton.center();
  textButton.mousePressed(nextAbstractAx3);
}
...
function selliseasja() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('sellise asja jätsin kahe silma vahele');
  textButton.center();
  textButton.mousePressed(nextAbstractAx2);
}
...
function silme() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('silme ees ja kahe silma vahele');
  textButton.center();
  textButton.mousePressed(nextAbstractAx3);
}
...
function eikola() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('ja ei kõla ka');
  textButton.center();
  textButton.mousePressed(nextAbstractAx2);
}
...
function agapoleka() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('aga pole ka');
  textButton.center();
  textButton.mousePressed(nextAbstractA);
}
...
function misoleks() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('mis oleks &#x2594');
  textButton.center();
  textButton.mousePressed(nextAbstractAx3);
}
...
function polekspidanud() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('ma poleks sind pidanud kuu aega tagasi nägema')
  textButton.center();
  textButton.mousePressed(nextAbstractAx2);
}
...
function ulekahekumne() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('üle kahekümne aasta')
  textButton.center();
  textButton.mousePressed(nextAbstractAx3);
}
...
function pogenesin() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('kas ma põgenesin?')
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
  textButton.mousePressed(nextAbstractAx3Bounce);
}
...
function StoryB() {
  ...
  easing = 0.25;
  clicks = 300;
  textButton = createButton('ma ei tea &#x2596 mis mul hakkas');
  textButton.mousePressed(nextStoryBounce);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function oksajupi() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('oksajupi &#x2596 juba tükkideks saetud kuuse küljest');
  textButton.mousePressed(nextStory);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function nojah2() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('olin võõras linnas');
  textButton.mousePressed(nextStory);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function nukker() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('kuigi kodus oleks ka olnud kuidagi nukker');
  textButton.center();
  textButton.mousePressed(nextAbstractAx2);
}
...
function uhke() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('uhke vaade');
  textButton.mousePressed(nextStoryBounce);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function kuuaega() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('ja sedasi kuu aega');
  textButton.center();
  textButton.mousePressed(nextAbstractAx2);
}
...
function kistud() {
  ...
  clickSND();
  flashMute();
  textButton = createButton('nagu oleks kistud inimesel riideid seljast');
  textButton.mousePressed(nextStory);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function hukkamist() {
  ...
  clickSND();
  flashMute();
  textButton = createButton('enne avalikku hukkamist');
  textButton.mousePressed(nextAbstractAx2);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function jumpB1() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('et kust küll selline hull mõte');
...
function StoryB2() {
  ...
  bcolTarget = 15;
  easing = 0.25;
  StoryButton = createButton('ma pole ju mingi rohepöörde mees');
...
function jumpB2() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('toob lihtsalt mingite korporatsioonide taskud raha täis');
...
function StoryB2One() {
  ...
  randombuttonsG();
  clicks = 337;
  StoryButton = createButton('KUULE');
...
function StoryB2Two() {
  ...
  randombuttonsG();
  clicks = 338;
  StoryButton = createButton('ÄRA NÜÜD NUTA!');
...
function StoryB3() {
  ...
  bcolTarget = 15;
  easing = 0.25;
  StoryButton = createButton('mul pole kuuskede raiumise vastu midagi');
  StoryButton.mousePressed(nextStory);
  StoryButton.center();
}
...
function jumpB3() {
  ...
  clickSND();
  flashMute();
  textButton = createButton('ja tagusin kuuse juppideks');
...
function kirve() {
  ...
  clickSND();
  flashMute();
  textButton = createButton('võtsin garaažist kirve');
  textButton.mousePressed(nextStory);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function StoryB3One() {
  ...
  randombuttonsG();
  clicks = 349;
  StoryButton = createButton('KUULE &#x2596 MIS SA NUTAD');
...
function StoryB3Two() {
  ...
  randombuttonsG();
  clicks = 350;
  StoryButton = createButton('SEE POLE MIDAGI!');
...
function StoryB4() {
  ...
  bcolTarget = 15;
  easing = 0.25;
  StoryButton = createButton('eks ta oli selle aja peale ära ka kuivanud');
  StoryButton.mousePressed(nextStory);
  StoryButton.center();
}
...
function jumpB4() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('ja seda veel ka siis &#x2596 kui lumi oli ammu ära sulanud');
...
function StoryB4Two() {
  ...
  randombuttonsG();
  clicks = 361;
  StoryButton = createButton('PALUN ÄRA TEE!');
...
function StoryB5() {
  ...
  bcolTarget = 15;
  easing = 0.25;
  StoryButton = createButton('nii et ma pole mingi puukallistaja');
  StoryButton.mousePressed(nextStory);
  StoryButton.center();
}
...
function jumpB5() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('olemuselt selline asjalikum mees pigem');
...
function StoryB5One() {
  ...
  randombuttonsG();
  clicks = 368;
  StoryButton = createButton('PALUN-PALUN!');
...
function StoryB6() {
  ...
  bcolTarget = 15;
  easing = 0.25;
  StoryButton = createButton('aga näe &#x2596 jube kurvaks tegi &#x2594');
...
function jumpB6() {
  ...
  clickSND();
  flashMute();
  textButton = createButton('et nad seal seda ilusat kuuske retsisid');
...
function StoryB6Two() {
  ...
  randombuttonsG();
  clicks = 376;
  StoryButton = createButton('KOHE SAAB LÄBI');
...
function StoryB6Three() {
  ...
  randombuttonsG();
  clicks = 376;
  StoryButton = createButton('MA JU ÜTLESIN &#x2596 ET TÜHIASI');
...
function StoryB7() {
  ...
  bcolTarget = 15;
  easing = 0.25;
  StoryButton = createButton('noh &#x2596 ühel päeval lülitasid elektri välja');
  StoryButton.mousePressed(nextStory);
  StoryButton.center();
}
...
function jumpB7() {
  ...
  clickSND();
  flashMute();
  textButton = createButton('ja saagisid kuuse tükkideks');
...
function StoryB7One() {
  ...
  randombuttonsG();
  clicks = 385;
  StoryButton = createButton('AITAB NÜÜD');
...
function StoryB7Two() {
  ...
  randombuttonsG();
  clicks = 386;
  StoryButton = createButton('MIS SA TÜHJA ASJA PÄRAST PILLID');
...
function StoryB8() {
  ...
  bcolTarget = 15;
  easing = 0.25;
  StoryButton = createButton('mul oli hommikul kohe koosolek');
  StoryButton.mousePressed(nextStory);
  StoryButton.center();
}
...
function jumpB8() {
  ...
  clickSND();
  flashMute();
  textButton = createButton('ja vaatasin &#x2596 kuidas nad kuuske hakkasid saagima');
...
function StoryB8Two() {
  ...
  randombuttonsG();
  clicks = 395;
  StoryButton = createButton('PÄRIS MEHED EI NUTA &#x2596 ONJU');
...
function StoryB8Three() {
  ...
  randombuttonsG();
  clicks = 396;
  StoryButton = createButton('KUULED VÕI?');
...
function StoryB9() {
  ...
  bcolTarget = 15;
  easing = 0.25;
  StoryButton = createButton('ikka alt ülespoole');
  StoryButton.mousePressed(nextStory);
  StoryButton.center();
}
...
function jumpB9() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('oks oksa haaval');
...
function StoryB9One() {
  ...
  randombuttonsG();
  clicks = 403;
  StoryButton = createButton('NO AITAB NÜÜD!');
...
function StoryB10() {
  ...
  bcolTarget = 15;
  easing = 0.25;
  StoryButton = createButton('õhtul tulin tagasi');
...
function hunnik() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('oligi ainult hunnik oksi alles');
  textButton.mousePressed(nextAbstractAx3);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function ehtes() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('täies ehtes ja puha');
  textButton.mousePressed(nextStory);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function fotosid() {
  ...
  clickSND();
  flashMute();
  textButton = createButton('ja tegid selle ees fotosid');
  textButton.mousePressed(nextAbstractAx2);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function risust() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('aga nüüd astuti risust üle');
  textButton.mousePressed(nextAbstractA);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function mismulhakkas() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('ja ma ei tea &#x2596 mis mul hakkas');
  textButton.mousePressed(nextAbstractA);
  textButton.center();
}
...
function oksahunniku() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('läksin oksahunniku juurde');
  textButton.mousePressed(nextStory);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function jumpB10() {
  ...
  clickSND();
  flashMute();
  textButton = createButton('ning murdsin ühe');
...
function StoryB11() {
  ...
  bcolTarget = 15;
  easing = 0.25;
  StoryButton = createButton('pistsin mantlitasku');
  StoryButton.mousePressed(nextAbstractA);
  StoryButton.center();
}
...
function unustasin() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('unustasin selle sinna terveks päevaks');
  textButton.mousePressed(nextAbstractAx3);
  textButton.center();
}
...
function jumpB11() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('avastasin oksa taksust');
...
function StoryB11One() {
  ...
  randombuttonsG();
  clicks = 427;
  StoryButton = createButton('KURAT');
...
function StoryB11Two() {
  ...
  randombuttonsG();
  clicks = 428;
  StoryButton = createButton('MA ÜTLESIN');
...
function StoryB11Three() {
  ...
  randombuttonsG();
  clicks = 429;
  StoryButton = createButton('AITAB!');
...
function StoryB12() {
  ...
  bcolTarget = 15;
  easing = 0.25;
  StoryButton = createButton('mõtlesin &#x2596 et mis sellega teha');
  StoryButton.mousePressed(nextAbstractAx3);
  StoryButton.center();
}
...
function viskaks() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('viskaks õige minema');
  textButton.mousePressed(nextAbstractAx2);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function jumpB12() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('siis mis ma sellest kohe minema viskan');
...
function StoryB12One() {
  ...
  randombuttonsG();
  clicks = 439;
  StoryButton = createButton('MISASJA');
...
function StoryB12Two() {
  ...
  randombuttonsG();
  clicks = 440;
  StoryButton = createButton('NÜÜD HAKKAD SINA KA TEDA KAITSMA');
...
function StoryB12Three() {
  ...
  randombuttonsG();
  clicks = 441;
  StoryButton = createButton('MINGI KUIVANUD PUU PÄRAST!');
...
function StoryB13() {
  ...
  bcolTarget = 15;
  easing = 0.25;
  StoryButton = createButton('võtsin minibaarist väikse viinapudeli');
  StoryButton.mousePressed(nextAbstractA);
  StoryButton.center();
}
...
function kallasin() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('kallasin joogi välja');
  textButton.mousePressed(nextAbstractAx2);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function vee() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('ja lasin kraanist vee asemele');
  textButton.mousePressed(nextAbstractAx3);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function jumpB13() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('pistsin kuuseoksa sinna');
...
function StoryB13One() {
  ...
  randombuttonsG();
  clicks = 450;
  StoryButton = createButton('HÄSTI');
...
function StoryB13Two() {
  ...
  randombuttonsG();
  clicks = 451;
  StoryButton = createButton('MA JÄTAN TA JÄRGMISEL AASTAL SIIA KUIVAMA');
...
function StoryB13Three() {
  ...
  randombuttonsG();
  clicks = 452;
  StoryButton = createButton('SEDA TAHATE VÕI?');
...
function StoryB13Four() {
  ...
  randombuttonsG();
  clicks = 453;
  StoryButton = createButton('LAIP ELUTOAS!');
...
function StoryB14() {
  ...
  bcolTarget = 15;
  easing = 0.25;
  StoryButton = createButton('nüüd ei teagi');
  StoryButton.mousePressed(nextStory);
  StoryButton.center();
}
...
function midamasellegateen() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('mida ma sellega teen');
  textButton.mousePressed(nextAbstractAx3);
  textButton.center();
}
...
function jumpB14() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('äkki ajab juure alla');
...
function StoryB14Two() {
  ...
  randombuttonsG();
  clicks = 462;
  StoryButton = createButton('MA EI VIHASTA');
...
function StoryB14Three() {
  ...
  randombuttonsG();
  clicks = 463;
  StoryButton = createButton('LIHTSALT AITAB NÜÜD');
...
function StoryB14Five() {
  ...
  randombuttonsG();
  clicks = 465;
  StoryButton = createButton('EI SAA OLLA SELLINE PIRIPILL!');
...
function StoryB15() {
  ...
  bcolTarget = 15;
  easing = 0.25;
  StoryButton = createButton('kui ajab &#x2596 siis viin koju');
...
function jumpB15() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('istutan aeda');
...
function StoryB15One() {
  ...
  randombuttonsG();
  clicks = 472;
  StoryButton = createButton('MULLE AITAB &#x2596 RAISK!');
...
function StoryB16() {
  ...
  bcolTarget = 15;
  easing = 0.25;
  StoryButton = createButton('ütlen Sandrile &#x2594');
  StoryButton.mousePressed(nextStory);
  StoryButton.center();
}
...
function emam() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('et ema mälestuseks');
  textButton.mousePressed(nextAbstractAx2);
  const dw = new DanceSpan(textButton, random(displayWidth * 0.1, displayWidth * 0.75), random(displayHeight * 0.1, displayHeight * 0.75));
        dancingWords.push(dw);
}
...
function omastkaest() {
  ...
  removeAllButtons();
  clickSND();
  textButton = createButton('või et nüüd on jõulupuu omast käest võtta');
  textButton.mousePressed(nextAbstractA);
  textButton.center();
}
...
function jumpB16() {
  ...
  clickSND();
  flashMute();
  textButton = createButton('ei pea saagima ega midagi');
  textButton.mousePressed(nextStory);
  textButton.center();
  boxButton = createButton('&#x258a');
...
function StoryC() {
  ...
  presetC1Zero();
  StoryButton = createButton('mul on sageli nii');
